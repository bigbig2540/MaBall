...
public class HardMode2Player extends Application {
    ...
    private PlayerHardMode player1;
    private PlayerHardMode player2;
    ...
    public HardMode2Player(String n1, String n2) {
        player1 = new PlayerHardMode();
        player1.setPlayerName(n1);
        player2 = new PlayerHardMode();
...
//        player1Name.setLayoutX(135);
//        player1Name.setLayoutY(42.5);
//
//        player2Name.setFont(Font.font("Bariol Regular", 45));
//        player2Name.setFill(Color.web("#3e3024"));
//        player2Name.setLayoutX(750);
//        player2Name.setLayoutY(42.5);
                ...
                public void handle(long now) {
                    ...
                    if (player1.isIsDeath() && player2.isIsDeath()) {
                        try {
                            ...
                            Logger.getLogger(HardMode2Player.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        this.stop();
            ...
            switch (event.getCode()) {
                case A:
                    if (player1.isPressStatus()) {
                        ...
                        RotateTransition rt = new RotateTransition(Duration.millis(50), nodePlayer);
                        rt.setByAngle(-90);
                        rt.setCycleCount(1);
                        rt.play();
                        ...
                        new Timeline(new KeyFrame(Duration.millis(50 / 2), (ActionEvent e) -> {
                            player1.swapPlayerStatLeft();
                        })).play();
                    }
                    break;
                case D:
                ...
                case LEFT:
                    if (player2.isPressStatus()) {
                        ...
                        RotateTransition rt = new RotateTransition(Duration.millis(50), nodePlayer2);
                        rt.setByAngle(-90);
                        rt.setCycleCount(1);
                        rt.play();
                        rt.setOnFinished((ActionEvent e) -> {
    ...
    private void spawnBall1(PlayerHardMode player) {
        ...
        if (waitFinish == 0) {
            ...
            if (randomY == 0) {
                ...
                ballObj.ballSetXandSetY(800, height * 0.5);
                ballObj.getPlayerSprite().setVisible(false);
            } else if (randomY == 2) {
                ballObj.ballSetXandSetY((width - ballObj.getWidth()) / 4.05, height + 100);
            } else if (randomY == 3) {
                ballObj.ballSetXandSetY(-100, height * 0.5);
            }
            ...
            new AnimationTimer() {
                ...
                int randomSpeed2 = 4 + (int) ((Math.random()) * 1);
                ...
                public void handle(long now) {
                    ...
                    if (randomY == 0) {
                        ...
                        if (ballObj.getPlayerSprite().getBoundsInParent().intersects(player.getPlayerSprite().getBoundsInParent())) {
                            System.out.println(player.getPlayerStatus(0) + player.getPlayerStatus(1) + player.getPlayerStatus(2) + player.getPlayerStatus(3));
                        ...
                        ballObj.setPositionX(ballObj.getPositionX() - randomSpeed2);
                        System.out.println(ballObj.getPositionX());
                        if (ballObj.getPositionX() < 575) {
                            ballObj.getPlayerSprite().setVisible(true);
                        }
                        if (ballObj.getPlayerSprite().getBoundsInParent().intersects(player.getPlayerSprite().getBoundsInParent())) {
                            System.out.println(player.getPlayerStatus(0) + player.getPlayerStatus(1) + player.getPlayerStatus(2) + player.getPlayerStatus(3));
                            if (player.getPlayerStatus(randomY).compareTo(ballObj.getBallStatus()) == 0) {
    ...
    private void spawnBall2(PlayerHardMode player2) {
        if (waitFinish2 == 0) {

            BallEzMode ballObj2 = new BallEzMode(player2.getColorListRandom());
            waitFinish2 = 1;
            randomY2 = (int) ((Math.random()) * 4);
            if (randomY2 == 0) {
                ballObj2.ballSetXandSetY((width - ballObj2.getWidth()) / 1.325, -100);
            } else if (randomY2 == 1) {
                ballObj2.ballSetXandSetY(1400, height * 0.5);
            } else if (randomY2 == 2) {
                ballObj2.ballSetXandSetY((width - ballObj2.getWidth()) / 1.325, height + 100);
            } else if (randomY2 == 3) {
                ballObj2.ballSetXandSetY(300, height * 0.5);
                ballObj2.getPlayerSprite().setVisible(false);
            }
                ...
                public void handle(long now) {
                    ...
                    if (randomY2 == 0) {
                        ...
                        if (ballObj2.getPlayerSprite().getBoundsInParent().intersects(player2.getPlayerSprite().getBoundsInParent())) {
                            System.out.println(player2.getPlayerStatus(0) + player2.getPlayerStatus(1) + player2.getPlayerStatus(2) + player2.getPlayerStatus(3));
                        ...
                        ballObj2.setPositionX(ballObj2.getPositionX() - randomSpeed2);
                        if (ballObj2.getPlayerSprite().getBoundsInParent().intersects(player2.getPlayerSprite().getBoundsInParent())) {
                            System.out.println(player2.getPlayerStatus(0) + player2.getPlayerStatus(1) + player2.getPlayerStatus(2) + player2.getPlayerStatus(3));
                            if (player2.getPlayerStatus(randomY2).compareTo(ballObj2.getBallStatus()) == 0) {
                                waitFinish2 = 0;
                        ...
                        ballObj2.setPositionX(ballObj2.getPositionX() + randomSpeed2);
                        if (ballObj2.getPositionX() > 600) {
                            ballObj2.getPlayerSprite().setVisible(true);
                        }
                        if (ballObj2.getPlayerSprite().getBoundsInParent().intersects(player2.getPlayerSprite().getBoundsInParent())) {
                            System.out.println(player2.getPlayerStatus(0) + player2.getPlayerStatus(1) + player2.getPlayerStatus(2) + player2.getPlayerStatus(3));
                            if (player2.getPlayerStatus(randomY2).compareTo(ballObj2.getBallStatus()) == 0) {
    ...
    private Parent GameOverScene(PlayerHardMode player1, PlayerHardMode player2) throws IOException {
        ...
        playAgainButton.getPlayerSprite().setOnMouseClicked(event -> {
            ...
            BGM.stop();
            try {
                HardMode2Player reStage = new HardMode2Player(player1.getPlayerName(), player2.getPlayerName());
                reStage.start(stage);
    ...
    /*private Parent GameOverScene(PlayerHardMode player1, PlayerHardMode player2) throws IOException {
        ...
        Box.setPrefSize(width / 2, height *0.9);
        displayScoreBox.setPrefSize(width / 2, height * 0.45);
        
        wBox.setPrefSize(width / 2, height * 1.4);
        wBox2.setPrefSize(width * 1.5, height * 1.4);
        
        Box2.setPrefSize(width * 1.5, height*0.9);
        displayScoreBox2.setPrefSize(width * 1.5, height * 0.45);
        
        dBox.setPrefSize(width/2, height *1.45);
        dBox2.setPrefSize(width*1.5, height *1.45);

        ImageView backGround = new ImageView(new Image("maballv1/pic/Menu/BG2PlayersGameOver2.png"));
        ...
        if (player1.getPlayerScore() > player2.getPlayerScore()) {
            wBox.getChildren().add(winner.getPlayerSprite());
        } else if (player2.getPlayerScore() > player1.getPlayerScore()) {
            wBox2.getChildren().add(winner.getPlayerSprite());
        }
        else if(player2.getPlayerScore() == player1.getPlayerScore()){
            Sprite draw = new Sprite("maballv1/pic/Menu/Draw.png");
            dBox.getChildren().add(draw.getPlayerSprite());
    ...
    public void writeScore(String[] a, String[] b, int score, String name) {
        ...
        try {
            FileWriter writer = new FileWriter("score2.txt", false);
            FileWriter writer2 = new FileWriter("name2.txt", false);
